      ...
      <header className="fixed top-0 left-0 right-0 z-[60]">
        ...
        <div className="glass-header flex items-center justify-between px-4 py-1 rounded-b-[2rem]">
          ...
          <img 
            src={logo} 
            alt="Logo" 
            className={`h-[5.5rem] w-auto max-w-[70vw] -my-4 transition-transform cursor-pointer select-none invert brightness-0 ${logoWiggle ? 'animate-[wiggle_0.4s_ease-in-out]' : ''}`}
