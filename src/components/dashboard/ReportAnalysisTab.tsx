...
}: {label: string;field: string;value: number;onChange: (field: string, value: number) => void;}) =>
  ...
  return (
    <div className="px-6 pb-8 animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="tracking-wide uppercase text-xl font-medium">ANALISI PRODUTTIVITÀ</h1>
