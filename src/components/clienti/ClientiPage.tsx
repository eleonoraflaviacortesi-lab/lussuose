...
export function ClientiPage({ initialClienteId: propClienteId, onClienteOpened }: ClientiPageProps = {}) {
  ...
  const handleExportExcel = useCallback(async () => {
    ...
    { header: 'Mutuo', key: 'mutuo', width: 12 },
    { header: 'Tempo Ricerca', key: 'tempo_ricerca', width: 15 },
    { header: 'Ha Visitato', key: 'ha_visitato', width: 12 },
    { header: 'Interesse Affitto', key: 'interesse_affitto', width: 16 },
    { header: 'Uso', key: 'uso', width: 14 },
    { header: 'Regioni', key: 'regioni', width: 25 },
    { header: 'Vicinanza Città', key: 'vicinanza_citta', width: 14 },
    { header: 'Motivo Zona', key: 'motivo_zona', width: 25 },
    { header: 'Tipologia', key: 'tipologia', width: 25 },
    { header: 'Stile', key: 'stile', width: 15 },
    { header: 'Contesto', key: 'contesto', width: 25 },
    { header: 'Dimensioni Min', key: 'dimensioni_min', width: 14 },
    { header: 'Dimensioni Max', key: 'dimensioni_max', width: 14 },
    { header: 'Camere', key: 'camere', width: 10 },
    { header: 'Bagni', key: 'bagni', width: 10 },
    { header: 'Layout', key: 'layout', width: 14 },
    { header: 'Dependance', key: 'dependance', width: 14 },
    { header: 'Terreno', key: 'terreno', width: 14 },
    { header: 'Piscina', key: 'piscina', width: 12 },
    { header: 'Portale', key: 'portale', width: 20 },
    { header: 'Property Name', key: 'property_name', width: 22 },
    { header: 'Ref Number', key: 'ref_number', width: 14 },
    { header: 'Contattato Da', key: 'contattato_da', width: 18 },
    { header: 'Tipo Contatto', key: 'tipo_contatto', width: 16 },
    { header: 'Assigned To', key: 'assigned_to', width: 28 },
    { header: 'Sede', key: 'sede', width: 12 },
    { header: 'Emoji', key: 'emoji', width: 8 },
    { header: 'Reminder Date', key: 'reminder_date', width: 20 },
    { header: 'Last Contact Date', key: 'last_contact_date', width: 20 },
    { header: 'Descrizione', key: 'descrizione', width: 40 },
    { header: 'Note Extra', key: 'note_extra', width: 40 },
    { header: 'Tally Submission ID', key: 'tally_submission_id', width: 22 },
    { header: 'Data Submission', key: 'data_submission', width: 20 },
    { header: 'Creato', key: 'created_at', width: 20 },
    { header: 'Aggiornato', key: 'updated_at', width: 20 }],
    displayClients.map((c) => ({
      ...c,
      regioni: Array.isArray(c.regioni) ? c.regioni.join(', ') : '',
      tipologia: Array.isArray(c.tipologia) ? c.tipologia.join(', ') : '',
      motivo_zona: Array.isArray(c.motivo_zona) ? c.motivo_zona.join(', ') : '',
      contesto: Array.isArray(c.contesto) ? c.contesto.join(', ') : '',
      ha_visitato: c.ha_visitato ? 'Sì' : 'No',
      vicinanza_citta: c.vicinanza_citta ? 'Sì' : 'No'
    })));
  }, [displayClients]);
